...
//mengupdate teks yang telah diinput kedalam bentuk enkripsi/dekripsi 
function upd()
{
...
//jika nilai a dan b di isi maka akan di lanjutkan jika error maka tidak di lanjutkan
   if (document.encoder.text.value == '')
   {
      e.innerHTML = 'Isi Planning Text...';
   }
...
function a_minus()
{//mengatur jumlah pengurangan jika diisi variable a
   var a = document.encoder.a.value;
   if (a < 2)
   {
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="treeview">
					  <a href="bootstrap/pages/widgets.html">
						<i class="fa fa-th"></i> <span>Affine Cipher</span>
				...
				<div class="box box-solid">
					...
					<div class="box-header with-border">
					  <i class="fa fa-arrow-circle-right"></i>
						<h3 class="box-title">Affine Cipher</h3>
					</div>
